...
Currently, this program only supports Windows Hosts.
...
-Install the following packages with Python Pip: pypresence, wmi, psutil, pyautogui

-Open the vmwplugin.py file with a text editor and look for "Enter your client ID". Paste the client ID from 
earlier in between the quotes "". Save the file
